...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> userError(RuntimeException exception,WebRequest request)
	{
		return handleExceptionInternal(exception,exception.toString(),new HttpHeaders(),HttpStatus.UNAUTHORIZED,request);
	}
	
	@ExceptionHandler(value = {InvalidIdException.class,AdvertiseNotFoundException.class})
	public ResponseEntity<Object> AdvertiseError(RuntimeException exception,WebRequest request)
	{
